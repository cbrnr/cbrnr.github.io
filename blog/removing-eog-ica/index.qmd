...
::: {.callout-important}
In the next step, we will use the Picard ICA algorithm, which is not included in MNE. Therefore, make sure to install it (see [here](../setting-up-python/index.qmd) for a quick overview of how to set up Python and install packages).
